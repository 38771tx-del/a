...
// High-performance texture cache with multi-threaded decoding
...
public:
    ...
    // Request texture decoding (non-blocking)
    ...
    // Get texture (thread-safe, lock-free read)
