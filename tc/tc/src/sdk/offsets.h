...
/*  Dumped At       : 21:34 17/03/2026 (GMT)
/*  Total Offsets   : 368
/* -------------------------------------------------------------
/*  Join the discord!                                           
...
#include <string>
namespace Offsets {
    inline std::string ClientVersion = "version-ae421f0582e54718";
    ...
    namespace AnimationTrack {
         ...
         inline constexpr uintptr_t IsPlaying = 0x3a2;
    ...
    namespace MouseService {
         ...
         inline constexpr uintptr_t SensitivityPointer = 0x8254d40;
    }
    ...
    namespace PlayerConfigurer {
         inline constexpr uintptr_t Pointer = 0x81b0ff8;
    }
    ...
    namespace TaskScheduler {
         ...
         inline constexpr uintptr_t Pointer = 0x8287b48;
    }
